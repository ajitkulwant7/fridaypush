...
declare var getPlayerScore;
var scoreEvent = new EventEmitter();
// Canvas
const { body } = document;
...
function showGameOverEl(score) {
  ...
  // Button
  // const sendScore = document.createElement('button');
  // sendScore.setAttribute('onclick', 'sentToComponnet()');
  // sendScore.textContent = 'Next';
  // let pscore = new PongComponent(this);
  // pscore.setScore(score);
  scoreEvent.emit(score);
  // Append
...
function gameOver() {
  ...
  showGameOverEl(playerScore);
  //  getPlayerScore(playerScore);
  // }
}
var getPlayerScore: any = () => {
  return playerScore;
};
// Called Every Frame
function animate() {
...
export class PongComponent implements OnInit {
  ...
  setScore(ps) {
    this.score = ps;
    console.log('in set' + ps + this.score);
    // this.openScoreDialog();
  }
  // backToHome() {
  //   this._location.back();
